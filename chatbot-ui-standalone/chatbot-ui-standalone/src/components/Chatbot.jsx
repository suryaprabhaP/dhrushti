...
function Chatbot({ onAddDocument, divisionName = "Bengaluru Division" }) {
  ...
  const [activeSessionId, setActiveSessionId] = useState(() => `conv_${Date.now()}_${Math.random().toString(36).substring(2, 7)}`);
      ...
      <div className="chat-sidebar-panel">
        ...
        <div className="sidebar-section">
          ...
          <div className="sidebar-agent-list">
            ...
            <button className="sidebar-agent-btn" onClick={() => handleSend('What has changed recently in Bengaluru?')}>
        ...
        <div className="sidebar-section">
          ...
          <div className="sidebar-action-grid">
            ...
            <button className="sidebar-action-chip" onClick={() => handleSend('Compare Bengaluru and Mysuru crime fingerprints')}>
