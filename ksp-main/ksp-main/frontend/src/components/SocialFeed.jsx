...
function SocialFeed() {
  ...
  return (
    <div className="insights-content" style={{ padding: '16px' }}>
      {/* Header */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px' }}>
        <div>
          <h3 className="section-title" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            🌐 Live MCP Social Media Engine
          </h3>
          <p className="section-desc">Real-time public social media & news feeds tagging @KarnatakaPolice.</p>
        </div>
        <div style={{ display: 'flex', gap: '6px' }}>
          ...
          >
            <Globe size={12} className={fetchingLive ? 'weather-icon-anim' : ''} />
            {fetchingLive ? 'Connecting Live...' : 'Connect Real Live Feed'}
          </button>
          <button 
